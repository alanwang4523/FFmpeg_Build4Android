...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO getMediaInfo  OK [ TrimVideoUtils.kt trim() #line 215 ]
    // TODO getVideoCodec OK [ TrimmerActivity.java checkCodec() #line 100 ]
    private static final String TEST_CMD_STR = " -i /sdcard/Alan/ffmpeg/test.mp4";

    // TODO 多视频合并 都 OK [ CaptureController.kt concatVideos() #line 1271 ]-->[ FFmpegUtils.java concatFiles() #line 232 ]
...
//            "-c copy /sdcard/Alan/ffmpeg/output_concat.mp4";
    ...
    // TODO 音频 + 图片 生成视频用于分享 OK [ AudioRecordingSharePresenter.kt mergeVideo() #line 141 ]
...
//            "-c:a copy -c:v libopenh264 -allow_skip_frames 1 -g 30 -r 15 -t 9000 -shortest /sdcard/Alan/ffmpeg/av_video.mp4";
    ...
    // TODO 音频 + 视频 Muxer OK，[ SMMediaMuxerController.java startMuxerByFFmpeg() #line 105 ]
...
//            "/sdcard/Alan/ffmpeg/src/st_test_01.mp4", "/sdcard/Alan/ffmpeg/src/music.m4a", "/sdcard/Alan/ffmpeg/muxer_out.mp4");
    ...
    // TODO 音视频旋转 OK [ TrimVideoUtils.kt rorate() #line 84 ]
...
//            "/sdcard/Alan/ffmpeg/src/st_test_01.mp4", 180, "/sdcard/Alan/ffmpeg/out_rotate.mp4");
    ...
    // TODO 音视频压缩 OK [ TrimVideoUtils.kt trim() #line 267 ]
...
//            "/sdcard/Alan/ffmpeg/4.mp4", 1000, 480, "/sdcard/Alan/ffmpeg/4_video.mp4");
    ...
    // TODO 音视频分离 OK [ TrimVideoUtils.kt trim() #line 281 ]
...
//        "/sdcard/Alan/ffmpeg/4.mp4", "/sdcard/Alan/ffmpeg/4_video.mp4", "/sdcard/Alan/ffmpeg/4_audio.aac");
    ...
    // TODO 音视频裁剪 OK [ TrimVideoUtils.kt trim() #line 320 ]
...
//            "/sdcard/Alan/ffmpeg/4.mp4", 200, "/sdcard/Alan/ffmpeg/out_trim.mp4");
    ...
    // TODO merge 多个视频，目前线上未实际使用， 执行出错，不支持 ts 输出格式，线上的 ffmpeg 也出错
    //  [ VideoShareHelper.java $MakeVideoTask::doInBackground() #line 142] --> [ VideoHelper.java merge() #line 92~93]

    // -f concat -safe 0 -i /sdcard/Alan/ffmpeg/src/concat_v1_v2.txt -c copy -bsf:a aac_adtstoasc /sdcard/Alan/ffmpeg/out_ts_merge.mp4
//    private static final String TEST_CMD_STR = String.format("-i %s -vcodec copy -acodec copy -f mpegts %s", "/sdcard/Alan/ffmpeg/src/st_test_01.mp4", "/sdcard/Alan/ffmpeg/src/st_test_01.mp4.ts");
//    private static final String TEST_CMD_STR = String.format("-i %s -vcodec copy -acodec copy -f mpegts %s", "/sdcard/Alan/ffmpeg/src/st_test_02.mp4", "/sdcard/Alan/ffmpeg/src/st_test_02.mp4.ts");
//    private static final String TEST_CMD_STR = String.format("-f concat -safe 0 -i %s -c copy -bsf:a aac_adtstoasc %s", "/sdcard/Alan/ffmpeg/src/concat_v1_v2.txt", "/sdcard/Alan/ffmpeg/out_ts_merge.mp4");
...
//        "/sdcard/Alan/ffmpeg/test.mp4", "/sdcard/Alan/ffmpeg/video_watermark.png", 5 * 1024, 200, 20, 20, "/sdcard/Alan/ffmpeg/out_watermark.mp4");
    ...
    // TODO 加水印，命令有误，执行出错 [ WaterMarkUtils.kt markVideo() #line 147 ]
    // -y -i /sdcard/Alan/ffmpeg/test.mp4 -i /sdcard/Alan/ffmpeg/video_watermark.png -acodec copy -filter_complex overlay /sdcard/Alan/ffmpeg/out_watermark_1.mp4
//    private static final String TEST_CMD_STR = String.format(Locale.US, " -y -i %s -i %s -acodec copy -filter_complex overlay %s",
//            "/sdcard/Alan/ffmpeg/test.mp4", "/sdcard/Alan/ffmpeg/video_watermark.png",  "/sdcard/Alan/ffmpeg/out_watermark_1.mp4");

...
#define FFMPEG_CONFIGURATION "--prefix=/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/ffmpeg-out/x86 --enable-gpl --disable-shared --enable-static --disable-small --disable-stripping --disable-debug --disable-ffmpeg --disable-pthreads --disable-w32threads --disable-os2threads --disable-ffplay --disable-ffprobe --disable-avdevice --disable-devices --disable-symver --disable-doc --disable-decoders --disable-encoders --disable-parsers --disable-protocols --enable-protocol=file --enable-parser=aac --enable-parser=mpegaudio --enable-parser=h264 --disable-devices --enable-decoder=aac --enable-decoder=pcm_s16le --enable-decoder=pcm_f32le --enable-decoder=h264 --enable-decoder=png --enable-decoder=mjpeg --enable-encoder=aac --enable-encoder=pcm_s16le --enable-encoder=pcm_f32le --enable-libopenh264 --enable-encoder=libopenh264 --enable-decoder=libopenh264 --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=hevc_mp4toannexb --enable-bsf=mpeg4_unpack_bframes --enable-bsf=h264_mp4toannexb --disable-muxers --enable-muxer=mp4 --enable-muxer=wav --enable-muxer=adts --disable-demuxers --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=wav --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=mov --enable-demuxer=matroska --enable-demuxer=concat --enable-demuxer=image2 --disable-filters --enable-filter=aresample --enable-filter=transpose --enable-filter=crop --enable-filter=scale --enable-filter=hflip --enable-filter=vflip --enable-filter=overlay --enable-zlib --enable-runtime-cpudetect --cross-prefix=/Users/wangjianjun/AndroidDev/android-ndk-r15c/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android- --target-os=android --arch=x86 --enable-cross-compile --sysroot=/Users/wangjianjun/AndroidDev/android-ndk-r15c/platforms/android-16/arch-x86 --extra-cflags='-O3 -ffast-math -fPIC -march=atom -msse3 -mfpmath=sse -I/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/openh264-out/x86/include -I/Users/wangjianjun/AndroidDev/android-ndk-r15c/platforms/android-16/arch-x86/usr/include' --extra-cxxflags='-O3 -ffast-math -fPIC -march=atom -msse3 -mfpmath=sse -I/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/openh264-out/x86/include -I/Users/wangjianjun/AndroidDev/android-ndk-r15c/platforms/android-16/arch-x86/usr/include' --extra-ldflags='-lm -lz -L/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/openh264-out/x86/lib' --extra-ldexeflags='-pie -fPIC -lm -lz -L/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/openh264-out/x86/lib' --disable-asm --disable-amd3dnow --disable-avx"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/ffmpeg-out/x86/share/ffmpeg"
#define AVCONV_DATADIR "/Users/wangjianjun/Alan/git/FFmpeg_Build4Android/FFmpeg-n4.0.2/../libs/ffmpeg-out/x86/share/ffmpeg"

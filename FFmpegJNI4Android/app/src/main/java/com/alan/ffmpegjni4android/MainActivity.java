...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TEST_CMD_STR = "ffmpeg -i asp:/sdcard/Alan/ffmpeg/test.mp4";
//    private static final String TEST_CMD_STR = "ffmpeg -y -i asp:/sdcard/Alan/ffmpeg/test.mp4 -vcodec copy /sdcard/Alan/ffmpeg/test_out.mp4";
//    private static final String TEST_CMD_STR = "ffmpeg -y -i asp:assets://test.mp4 -vcodec copy /sdcard/Alan/ffmpeg/test_out.mp4";
